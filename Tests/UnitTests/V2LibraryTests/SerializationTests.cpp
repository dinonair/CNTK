...
{
    ifstream modelFileStream("batch.norm.no.sample.count.v2.bin", ios::in | ios::binary);
    modelFileStream.seekg(0, ios::end);
    size_t length = modelFileStream.tellg();
    modelFileStream.seekg(0, ios::beg);
...
{
    ifstream modelFileStream("batch.norm.no.sample.count.v1.bin", ios::in | ios::binary);
    modelFileStream.seekg(0, ios::end);
    size_t length = modelFileStream.tellg();
    modelFileStream.seekg(0, ios::beg);
    char* modelBuffer = new char[length];
